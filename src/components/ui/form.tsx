...
/**
 * Ponte React Hook Form ⇄ Design System.
 * Todo formulário do projeto usa estes componentes — nenhum <input> avulso
 * com validação própria (regra anti-duplicação 2, docs/04).
 */
